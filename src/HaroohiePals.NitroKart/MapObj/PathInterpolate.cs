...
static class PathInterpolate
{
    public static Vector3d InterpolateXYZ(PathwalkerPathPart part, double t)
    {
        HermiteSplineCalcCoef(t, out double c0, out double c1, out double c2, out double c3);
        return ApplyCoefXYZ(part, c0, c1, c2, c3);
    }

    public static void pw_20D939C(PathwalkerPathPart part, double a2, double a3, out Vector3d a4,
        out Vector3d a5)
    {
    ...
    public static Vector3d InterpolateXZ(PathwalkerPathPart part, double t)
    {
        HermiteSplineCalcCoef(t, out double c0, out double c1, out double c2, out double c3);
        return ApplyCoefXZ(part, c0, c1, c2, c3);
    }

    public static void pw_20D9270_XZ(PathwalkerPathPart part, double a2, double a3, out Vector3d a4,
        out Vector3d a5)
    {
        HermiteSplineCalcCoef2(a2, out double coef1, out double coef2, out double coef3, out double coef4,
            out double a6, out double a7, out double a8, out double a9);
    ...
    public static Vector3d InterpolateXZLinearY(PathwalkerPathPart part, double t)
    {
        HermiteSplineCalcCoef(t, out double c0, out double c1, out double c2, out double c3);
    ...
    private static Vector3d ApplyCoefXYZ(PathwalkerPathPart part, double c0, double c1, double c2, double c3)
        => part.P0 * c0 + part.P1 * c1 + part.P2 * c2 + part.P3 * c3;

    private static Vector3d ApplyCoefXZ(PathwalkerPathPart part, double c0, double c1, double c2, double c3)
    {
